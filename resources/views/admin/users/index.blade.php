<x-layouts.admin>
    <div class="mb-4 flex justify-between items-center">
        ...
        <flux:breadcrumbs>
            ...
            <flux:breadcrumbs.item href="#">{{__('Users')}}</flux:breadcrumbs.item>
        </flux:breadcrumbs>
        <a href="{{ route('admin.users.create') }}" class="btn btn-blue">{{__('Create User')}}</a>
    </div>
            ...
            <tbody>
                @foreach ($users as $user)
                    <tr class="border-b hover:bg-neutral-primary-soft/50">
                        ...
                        <td class="px-6 py-4 font-medium text-body lowercase">
                            {{ $user->email }}
                        </td>
